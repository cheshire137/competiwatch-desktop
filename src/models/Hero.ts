export type HeroDetailedRole = 'DPS' | 'Flanker' | 'Hitscan' | 'Defense' | 'Off-tank' | 'Main Tank' | 'Main Healer' | 'Off-healer';
...
export type Hero = 'Ana' | 'Ashe' | 'Baptiste' | 'Bastion' | 'Brigitte' | 'D.Va' | 'Doomfist' | 'Genji' | 'Hanzo' | 'Junkrat' | 'Lúcio' | 'McCree' | 'Mei' | 'Mercy' | 'Moira' | 'Orisa' | 'Pharah' | 'Reaper' | 'Reinhardt' | 'Roadhog' | 'Sigma' | 'Soldier: 76' | 'Sombra' | 'Symmetra' | 'Torbjörn' | 'Tracer' | 'Widowmaker' | 'Winston' | 'Wrecking Ball' | 'Zarya' | 'Zenyatta';

export const HeroDetailedRoles: HeroDetailedRole[] = ['DPS', 'Flanker', 'Hitscan', 'Defense', 'Off-tank', 'Main Tank', 'Main Healer', 'Off-healer'];

export const Heroes: Hero[] = ['Ana', 'Ashe', 'Baptiste', 'Bastion', 'Brigitte', 'D.Va', 'Doomfist', 'Genji', 'Hanzo', 'Junkrat', 'Lúcio', 'McCree', 'Mei', 'Mercy', 'Moira', 'Orisa', 'Pharah', 'Reaper', 'Reinhardt', 'Roadhog', 'Sigma', 'Soldier: 76', 'Sombra', 'Symmetra', 'Torbjörn', 'Tracer', 'Widowmaker', 'Winston', 'Wrecking Ball', 'Zarya', 'Zenyatta'];

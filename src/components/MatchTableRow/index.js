  ...
  render() {
    ...
    return (
      <tr className={this.outerClass()}>
        <td className={this.matchNumberClass()}>{this.matchNumber()}</td>
        {showRole && (
          <td className={this.roleClass()}>
        ...
        <td className={this.streakClass()} style={this.streakStyle()}>
          {isWin || isLoss ? (
            <span className={`darken-change darken-change-${result}`} />
          ) : null}
          {isWin ? (
        ...
        <td className={`match-cell no-wrap ${this.mapBackgroundClass()}`}>
          {map}
        </td>
        {showComment ? (
          <td
        ...
        {showGroup ? (
          <td className={this.groupClass()} aria-label={this.groupTooltip()}>
            {groupList.length > 0 ? (

...
const GroupMembersField = ({ group, groupMembers, latestGroup, onGroupChange }: Props) => {
    ...
    <dl className="form-group mt-0">
      ...
      <dd>
        <ReactAutocomplete
          ...
          items={groupMembers}
          onChange={evt => onGroupChange(evt.target.value, groupSizeFrom(evt.target.value))}
